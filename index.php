  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Johny sins</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <!-- Sidebar -->  <li class="nav-item has-treeview menu-open">
            <a href="#" class="nav-link active">
              ...
              <p> Dashboard <em class="right fa fa-angle-left"></em> </p>
            </a>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>
                Salary <em class="fa fa-angle-left right"></em> </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Users Log<br>
                <em class="fa fa-angle-left right"></em> </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
